...
{
    private static String json_url ="https://run.mocky.io/v3/24abb41a-8600-4025-b746-7292f4059e0f";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar=findViewById(R.id.progressbar_3);
        product_list=new ArrayList<>();
        recyclerView_desk = findViewById(R.id.recycleviewid_display);
