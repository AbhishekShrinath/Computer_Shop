...
{
    private static String json_url ="https://run.mocky.io/v3/3662e796-9dfa-444c-990f-cbe6ce431df3";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        bar=findViewById(R.id.progressbar_2);
        product_list=new ArrayList<>();
        recyclerView_desk = findViewById(R.id.recycleviewid_storage);
